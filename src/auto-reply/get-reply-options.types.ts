...
export type StartupProgressContext = {
  phase: string;
...
export type GetReplyOptions = {
  ...
  /** Notifies channel surfaces about coarse pre-model startup phases for diagnostics/progress. */
  onStartupProgress?: (ctx: StartupProgressContext) => Promise<void> | void;
