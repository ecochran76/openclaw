---
id: commit-and-push-cadence
title: Commit And Push Cadence
summary: Checkpoint work often enough for safety and collaboration, but not so noisily that history stops being useful.
tags:
  - git
  - commits
  - push
