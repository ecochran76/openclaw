...
- At the start of non-trivial work, read the relevant policy file:
  ...
  - `docs/dev/policies/planning-notes-memory.md` for new plans, durable notes, repo memories, roadmap/runbook migration, or continuity artifacts.
  - `docs/dev/policies/graph-backed-memory.md` for Graphiti-backed memory reads/writes, memory cleanup, or durable operator-context questions.
