...
export const ChannelAccountSnapshotSchema = Type.Object(
  {
    ...
    lastSocketConnectedAt: Type.Optional(Type.Union([Type.Integer({ minimum: 0 }), Type.Null()])),
    lastSocketDisconnectedAt: Type.Optional(
      Type.Union([Type.Integer({ minimum: 0 }), Type.Null()]),
    ),
    lastSocketReconnectAt: Type.Optional(Type.Union([Type.Integer({ minimum: 0 }), Type.Null()])),
    lastSocketEnvelopeAt: Type.Optional(Type.Union([Type.Integer({ minimum: 0 }), Type.Null()])),
    lastSlackEventAt: Type.Optional(Type.Union([Type.Integer({ minimum: 0 }), Type.Null()])),
    socketActiveState: Type.Optional(
      Type.Union([Type.Literal("active"), Type.Literal("inactive"), Type.Literal("unknown")]),
    ),
    socketActiveStateAvailable: Type.Optional(Type.Boolean()),
    socketConnectionCount: Type.Optional(Type.Integer({ minimum: 0 })),
    socketModeSettings: Type.Optional(
      Type.Object(
        {
          clientPingTimeout: Type.Integer({ minimum: 1 }),
          connectionCount: Type.Integer({ minimum: 1 }),
          serverPingTimeout: Type.Optional(Type.Integer({ minimum: 1 })),
          pingPongLoggingEnabled: Type.Optional(Type.Boolean()),
        },
        { additionalProperties: false },
      ),
    ),
    socketConnections: Type.Optional(Type.Record(Type.String(), Type.Unknown())),
