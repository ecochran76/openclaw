...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.automation": "Automation",
  "agents.defaults.automation.maxConcurrent": "Automation Max Concurrent",
  "agents.defaults.automation.defaultMaxTurns": "Automation Default Max Turns",
  "agents.defaults.automation.defaultMaxTokens": "Automation Default Max Tokens",
  "agents.defaults.automation.defaultMaxDurationSeconds":
    "Automation Default Max Duration (seconds)",
  "agents.defaults.automation.model": "Automation Model",
  "agents.defaults.automation.thinking": "Automation Thinking",
  "agents.defaults.automation.announceTimeoutMs": "Automation Announce Timeout (ms)",
  ...
  "auth.usagePolicy": "Usage Policy",
  "auth.usagePolicy.enabled": "Usage Policy Enabled",
  "auth.usagePolicy.refreshMinutes": "Usage Policy Refresh (minutes)",
  "auth.usagePolicy.staleAfterMinutes": "Usage Policy Stale After (minutes)",
  "auth.usagePolicy.staleBehavior": "Usage Policy Stale Behavior",
  "auth.usagePolicy.defaults": "Default Usage Policy",
  "auth.usagePolicy.defaults.warn": "Default Usage Warnings",
  "auth.usagePolicy.defaults.stop": "Default Usage Stops",
  "auth.usagePolicy.defaults.switch": "Default Usage Switches",
  "auth.usagePolicy.defaults.respectUserOverride": "Default Usage Respects User Override",
  "auth.usagePolicy.defaults.onNoSwitchTarget": "Default Usage No-Switch Action",
  "auth.usagePolicy.defaults.surfaces": "Default Usage Surfaces",
  "auth.usagePolicy.defaults.surfaces.status": "Default Usage Status Surface",
  "auth.usagePolicy.defaults.surfaces.sessionStatus": "Default Usage Session Status Surface",
  "auth.usagePolicy.defaults.surfaces.preflightNotice": "Default Usage Preflight Surface",
  "auth.usagePolicy.defaults.warn[].window": "Default Usage Warning Window",
  "auth.usagePolicy.defaults.warn[].remainingPercentLte": "Default Usage Warning Remaining Percent",
  "auth.usagePolicy.defaults.stop[].window": "Default Usage Stop Window",
  "auth.usagePolicy.defaults.stop[].remainingPercentLte": "Default Usage Stop Remaining Percent",
  "auth.usagePolicy.defaults.switch[].window": "Default Usage Switch Window",
  "auth.usagePolicy.defaults.switch[].remainingPercentLte":
    "Default Usage Switch Remaining Percent",
  "auth.usagePolicy.providers": "Provider Usage Policies",
  "auth.usagePolicy.providers.*": "Provider Usage Policy",
  "auth.usagePolicy.providers.*.warn": "Provider Usage Warnings",
  "auth.usagePolicy.providers.*.stop": "Provider Usage Stops",
  "auth.usagePolicy.providers.*.switch": "Provider Usage Switches",
  "auth.usagePolicy.providers.*.respectUserOverride": "Provider Usage Respects User Override",
  "auth.usagePolicy.providers.*.onNoSwitchTarget": "Provider Usage No-Switch Action",
  "auth.usagePolicy.providers.*.surfaces": "Provider Usage Surfaces",
  "auth.usagePolicy.providers.*.surfaces.status": "Provider Usage Status Surface",
  "auth.usagePolicy.providers.*.surfaces.sessionStatus": "Provider Usage Session Status Surface",
  "auth.usagePolicy.providers.*.surfaces.preflightNotice": "Provider Usage Preflight Surface",
  "auth.usagePolicy.providers.*.warn[].window": "Provider Usage Warning Window",
  "auth.usagePolicy.providers.*.warn[].remainingPercentLte":
    "Provider Usage Warning Remaining Percent",
  "auth.usagePolicy.providers.*.stop[].window": "Provider Usage Stop Window",
  "auth.usagePolicy.providers.*.stop[].remainingPercentLte":
    "Provider Usage Stop Remaining Percent",
  "auth.usagePolicy.providers.*.switch[].window": "Provider Usage Switch Window",
  "auth.usagePolicy.providers.*.switch[].remainingPercentLte":
    "Provider Usage Switch Remaining Percent",
  "auth.usagePolicy.profiles": "Profile Usage Policies",
  "auth.usagePolicy.profiles.*": "Profile Usage Policy",
  "auth.usagePolicy.profiles.*.warn": "Profile Usage Warnings",
  "auth.usagePolicy.profiles.*.stop": "Profile Usage Stops",
  "auth.usagePolicy.profiles.*.switch": "Profile Usage Switches",
  "auth.usagePolicy.profiles.*.respectUserOverride": "Profile Usage Respects User Override",
  "auth.usagePolicy.profiles.*.onNoSwitchTarget": "Profile Usage No-Switch Action",
  "auth.usagePolicy.profiles.*.surfaces": "Profile Usage Surfaces",
  "auth.usagePolicy.profiles.*.surfaces.status": "Profile Usage Status Surface",
  "auth.usagePolicy.profiles.*.surfaces.sessionStatus": "Profile Usage Session Status Surface",
  "auth.usagePolicy.profiles.*.surfaces.preflightNotice": "Profile Usage Preflight Surface",
  "auth.usagePolicy.profiles.*.warn[].window": "Profile Usage Warning Window",
  "auth.usagePolicy.profiles.*.warn[].remainingPercentLte":
    "Profile Usage Warning Remaining Percent",
  "auth.usagePolicy.profiles.*.stop[].window": "Profile Usage Stop Window",
  "auth.usagePolicy.profiles.*.stop[].remainingPercentLte": "Profile Usage Stop Remaining Percent",
  "auth.usagePolicy.profiles.*.switch[].window": "Profile Usage Switch Window",
  "auth.usagePolicy.profiles.*.switch[].remainingPercentLte":
    "Profile Usage Switch Remaining Percent",
  ...
  "agents.list.*.sessionMaintenance": "Agent Session Maintenance",
  ...
  "session.agentToAgent.relay": "Agent-to-Agent Relay",
  ...
  "session.maintenance.artifactArchiveRetention": "Session Artifact Archive Retention",
  ...
  "agents.list[].sessionMaintenance": "Agent Session Maintenance",
  "agents.list[].sessionMaintenance.mode": "Agent Session Maintenance Mode",
  "agents.list[].sessionMaintenance.pruneAfter": "Agent Session Prune After",
  "agents.list[].sessionMaintenance.maxEntries": "Agent Session Max Entries",
  "agents.list[].sessionMaintenance.artifactArchiveRetention":
    "Agent Session Artifact Archive Retention",
  "agents.list[].sessionMaintenance.maxDiskBytes": "Agent Session Max Disk Budget",
  "agents.list[].sessionMaintenance.highWaterBytes": "Agent Session Disk High-water Target",
