---
id: upstream-fork-maintenance
title: Upstream Fork Maintenance
summary: Isolate private work from upstream sync, rebase private branches deliberately, and rewrite history only where ownership and safety are clear.
tags:
  - git
  - fork
  - upstream
