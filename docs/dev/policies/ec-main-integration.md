...
3. run focused preservation tests for touched feature families; use `scripts/ec-main-rebase-gate.sh --family <profiles|slack-a2a|slack-responsiveness|automation|voice|all>` for the bundled local feature gates
4. run `pnpm check`
