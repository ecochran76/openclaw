...
function collectConfiguredMcpServerNameMap(cfg: OpenClawConfig): Map<string, string> {
...
export function collectPluginToolAllowlistWarnings(params: {
  ...
  const configuredMcpServers = collectConfiguredMcpServerNameMap(params.cfg);
