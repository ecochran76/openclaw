...
- direct `openclaw agent --agent odollo-example ...` still worked because the
...
- Config repo: `/home/user/.openclaw`
- Config writer: `2026.4.23`
- Gateway process:
  `/home/user/.nvm/versions/node/v24.13.0/lib/node_modules/openclaw/dist/index.js`
- Gateway build: `OpenClaw 2026.4.23 (98a27c3)`
- Previous shell CLI path:
  `/home/user/.nvm/versions/node/v24.14.0/bin/openclaw`
...
Odollo example tenant heartbeat. The heartbeat is configured under the agent definition:
