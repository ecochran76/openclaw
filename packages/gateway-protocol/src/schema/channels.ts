...
export const ChannelAccountSnapshotSchema = Type.Object(
  {
    ...
    lastSocketConnectedAt: Type.Optional(Type.Integer({ minimum: 0 })),
    lastSocketDisconnectedAt: Type.Optional(Type.Integer({ minimum: 0 })),
    lastSocketReconnectAt: Type.Optional(Type.Integer({ minimum: 0 })),
    lastSocketEnvelopeAt: Type.Optional(Type.Integer({ minimum: 0 })),
    lastSlackEventAt: Type.Optional(Type.Integer({ minimum: 0 })),
