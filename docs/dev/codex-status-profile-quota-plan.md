...
Status: historical design, superseded by the canonical `openai` ownership and retained thin status policy in [Plan 0014](/dev/plans/0014-2026-06-28-profile-support-retirement).
