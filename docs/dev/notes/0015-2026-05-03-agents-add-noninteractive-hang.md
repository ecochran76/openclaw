...
While installing the example tenant marketing specialist in the live OpenClaw home,
...
```bash
openclaw agents add example-marketing \
  --workspace /home/user/.openclaw/workspace-example-marketing \
...
- The expected agent state directory was not created under
  `~/.openclaw/agents/example-marketing/agent`.
