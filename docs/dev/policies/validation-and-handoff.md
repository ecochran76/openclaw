...
- Local feature gates: prefer `scripts/ec-main-rebase-gate.sh --family <profiles|slack-a2a|slack-responsiveness|automation|voice|all>` so the maintained command bundle stays centralized.
