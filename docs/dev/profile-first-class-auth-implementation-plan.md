...
Status: historical — superseded by Plan 0014
Owner: dev-openclaw
Scope: make provider auth profiles truly first-class, reliable, and trunk-first across CLI/runtime/session UX.

> Do not execute this plan. `docs/dev/plans/0014-2026-06-28-profile-support-retirement.md`
> replaced its JSON-canonical storage design with the upstream-owned SQLite store and retains only
> the thin local operator UX and policy layer.
